    ...
    <div style={{ minHeight: '100vh', background: '#f8fdf9', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: secondary, borderRadius: 16, boxShadow: '0 2px 16px #e8f5e9', padding: 36, minWidth: 320, maxWidth: 400, width: '100%' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 24 }}>
          <input type="file" accept="image/*" onChange={handlePhoto} style={{ display: 'none' }} id="profile-photo-upload" />
        ...
        <input placeholder="Default pickup location" value={pickup} onChange={e => setPickup(e.target.value)} style={{ width: '100%', marginBottom: 16, padding: 12, borderRadius: 8, border: `1px solid ${primary}` }} />
